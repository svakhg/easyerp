<div class="center-div">
    <div class="center-div-header">当前位置：【 婚礼需求管理  >  审核查询 】</div>
    <div class="customrecordiv comct">
            ...
            <table class="systemlogtb" style="width:900px;">
                <tr>
                    ...
                    <td colspan="7"><input id="wed_from" name="wed_from" class="datebox wed_from"> 至 <input id="wed_to" name="wed_to" class="datebox wed_to">
                        &nbsp;&nbsp;&nbsp;&nbsp;交易状态：<select id="status" name="status" class="selectbox com-width100 status">
                            <option value="">--请选择--</option>
                            <option value="1">待分配商家</option>
                            <option value="4">待审核</option>
                            <option value="11">待商家响应</option>
                            <option value="21">商家投标中</option>
                            <option value="36">待选中标商家</option>
                            <option value="98">招投标完成</option>
                            <option value="99">已关闭</option>
                        </select>
                    </td><!--(1:需求审核中 - 无商家,2:是,3:否,4:需求审核中 - 有商家,80:交易成功,96:自荐信审核全部不通过,97:合作商拒绝接单,98:合作商响应超时,99:需求关闭)-->
                </tr>
                <tr>
        ...
        <div class="filtertb">
            <ul>
                <li class="filtertb-on">全部</li>
                <li class="filtertb-off" id="wedplanners_1">找策划</li>
                <li class="filtertb-off" id="wedmaster_1">找主持</li>
                <li class="filtertb-off" id="makeup_1">找化妆</li>
                <li class="filtertb-off" id="wedphotoer_1">找摄影</li>
                <li class="filtertb-off" id="wedvideo_1">找摄像</li>
                <li class="filtertb-off" id="sitelayout_1">找场布</li>
            </ul>
        </div>
...
<script type="text/javascript">
    seajs.use("<?php echo $config['srcPath'];?>/js/bsnsbidmanage/bsnsbidsearch");
</script>
</body>
</html>
