<div class="center-div">
	<div class="center-div-header">当前位置：【 婚礼需求管理  >  客户需求查询 】</div>
...
<div id="edit" class="editbsns">
    ...
    <div class="easyuitabs" id="tbs" style="width:100%;height:284px;">
        ...
        <div title="摄影师" style="padding:10px">
            <table id="wedphotoer" data="1423" class="datagrid bsnstb" style="width:99%;height:240px;"></table>
        </div>
        <div title="摄像师" style="padding:10px">
            <table id="wedvideo" data="1426" class="datagrid bsnstb" style="width:99%;height:240px;"></table>
        </div>
...
<script type="text/javascript">
    seajs.use("<?php echo $config['srcPath'];?>/js/trademanage/demandsearch");
</script>
</body>
</html>