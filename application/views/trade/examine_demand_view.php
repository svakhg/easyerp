<div class="center-div">
	<div class="center-div-header">当前位置：【 婚礼需求管理  >  需求详情 】</div>
	<div class="comct">
		<div id="maincontent">
								...
								<table>
									...
									<tr>
										...
										<td>
											...
											?>
											<!-- new -->
											<label><input type="radio" name="budget" class="radchk" value="2万以下" <?php if($base['budget']=="2万以下"){?> checked="checked" <?php }?>/>2万以下</label>
											<label><input type="radio" name="budget"class="radchk" value="2-4万" <?php if($base['budget']=="2-4万"){?> checked="checked" <?php }?>/>2-4万</label>
											<label><input type="radio" name="budget" class="radchk" value="4-7万" <?php if($base['budget']=="4-7万"){?> checked="checked" <?php }?>/>4-7万</label>
											<label><input type="radio" name="budget"class="radchk" value="7-10万" <?php if($base['budget']=="7-10万"){?> checked="checked" <?php }?>/>7-10万</label>
											<label><input type="radio" name="budget" class="radchk" value="10万以上" <?php if($base['budget']=="10万以上"){?> checked="checked" <?php }?>/>10万以上</label>
											<label><input type="radio" name="budget" class="radchk" value="没有概念，先聊聊" <?php if($base['budget']=="没有概念，先聊聊"){?> checked="checked" <?php }?>/>没有概念，先聊聊</label>
											<!-- new -->
											<!-- old -->
											<label><input type="radio" name="budget" class="radchk" value="1.5万以下" disabled <?php if($base['budget']=="1.5万以下"){?> checked="checked" <?php }?>/>1.5万以下</label>
											<label><input type="radio" name="budget"class="radchk" value="1.5-3万" disabled <?php if($base['budget']=="1.5-3万"){?> checked="checked" <?php }?>/>1.5-3万</label>
											<label><input type="radio" name="budget" class="radchk" value="3-5万" disabled <?php if($base['budget']=="3-5万"){?> checked="checked" <?php }?>/>3-5万</label>
											<label><input type="radio" name="budget"class="radchk" value="5-10万" disabled <?php if($base['budget']=="5-10万"){?> checked="checked" <?php }?>/>5-10万</label>
											<!-- old -->
											<label><input type="radio" name="budget" id="budgetdefined" class="radchk" value="" <?php if(!in_array($base['budget'],$arr)){?> checked="checked" <?php }?>/>自定义</label>
											<label class="optional">
											<input class="textbox customer" id="budgetvalue" maxlength="30" placeholder="请输入您的预算" value="<?php echo isset($base['budget']) ? $base['budget'] : ""?>">（元）
										</td>
									</tr>
								</table>
							</div>
								...
								<table>
									...
									<tr>
										<td>
											...
											<label><input type="radio" name="importance" class="radchk" value="" <?php if(!in_array($importance,$arr)):?>checked="checked"<?php endif;?>/>其它</label>
											<label class="optional">
											<input class="textbox customer"  maxlength="30" placeholder="请输入您的想法" value="<?php echo  isset($importance) ? $importance :"";?>">
											</label>
										</td>
									</tr>
									<tr>
...
<script type="text/javascript">
	seajs.use("<?php echo $config['srcPath'];?>/js/trademanage/examieincludm");
</script>
</body>
</html>