							...
							<div class="modulars">
								...
								<table>
									...
									<!-- <tr>
										...
										<td>
										<span><?php echo $base['people_num'];?></span>
									...
									<!-- <tr>
										...
										<td>
											...
											<span><?php echo $base['budget'];?></span>
														 <label><input type="radio" name="budget" class="radchk" value="2万以下" <?php if($base['budget']=="2万以下"){?> checked="checked" <?php }?>/>2万以下</label>
											            <label><input type="radio" name="budget"class="radchk" value="2-5万" <?php if($base['budget']=="2-5万"){?> checked="checked" <?php }?>/>2-5万</label>
											            <label><input type="radio" name="budget" class="radchk" value="5-10万" <?php if($base['budget']=="5-10万"){?> checked="checked" <?php }?>/>5-10万</label>
											            <label><input type="radio" name="budget"class="radchk" value="10-20万" <?php if($base['budget']=="10-20万"){?> checked="checked" <?php }?>/>10-20万</label>
											            <label><input type="radio" name="budget" class="radchk" value="20-50万" <?php if($base['budget']=="20-50万"){?> checked="checked" <?php }?>/>20-50万</label>
											            <label><input type="radio" name="budget"class="radchk" value="50万以上" <?php if($base['budget']=="50万以上"){?> checked="checked" <?php }?>/>50万以上</label><br />
											            <label><input type="radio" name="budget"class="radchk" value="" <?php if($base['budget']=="自定义"){?> checked="checked" <?php }?>/>自定义</label>
											            <label class="optional">
								...
								<table>
									...
									<tr>
										<td>
											...
											<textarea name="wedmaster_remark" class="custextarea com-width300" maxlength="500" placeholder="请输入其他的要求或喜好"><?php echo $wedmaster[1]['answer']?></textarea>
										</td>
									</tr>
								...
								<table>
									...
									<tr>
										<td>
											...
											<label><input type="checkbox" name="ideal" class="radchk" value="气质" <?php if(in_array("气质",$color)){?> checked="checked" <?php }?>/>气质</label>
...
<script type="text/javascript">
	seajs.use("<?php echo $config['srcPath'];?>/js/trademanage/perfectmultdm");
</script>
</body>
</html>