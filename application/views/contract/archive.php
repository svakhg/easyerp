 <!-- 右侧主体开始-->
    <div class="center-div">
        <div class="center-div-header">当前位置：【 合同处理  >  合同归档 】</div>
            ...
            <form id="demand_search" class="easyui-form" method="get" data-options="novalidate:true">
                <table class="systemlogtb">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="con_type" name="archive_status" class="selectbox com-width150">
                                <option value="">全部</option>
                                <?php foreach ($archivestatus as $key => $val) : ?>
								<option value="<?php echo $val;?>" <?php echo $val == $archivestatus['no_archive'] ? 'selected' : '' ?> ><?php echo $archivestatus_explan[$key];?></option>
								<?php endforeach;?>
                            </select>
                        </td>
                    ...
                    <input id="check_status" type="hidden" name="contract_status" value="<?php echo $contractstatus['confirmed']?>">
                    ...
                    <tr>
                        <td colspan="10">
                            ...
                            <a href="javascript:void(0)" class="easyui-linkbutton c7 auth-none" data-options="iconCls:'icon-redo'" id="exportBtn" data-auth="api/contract/exportArchive">导 出</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
...
<div id="rejectlayer" class="examinedlg">
 ...
 <div id="check-contract" class="contract-confirm-dialog">
     <div><a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" data-auth="api/contract/archive">归档确认</a></div>
     <div class="tablebox">
         <table>
             <tr>
...
<script type="text/javascript">
    seajs.use("<?php echo $config['srcPath'];?>/js/contract/archive");
</script>
</body>
</html>