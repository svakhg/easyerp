...
class Bidcomplete extends App_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('trade/bidcomplete_view',$infos);
    }
    ...
    public function getlist()
    {
        ...
        foreach($result['rows'] as &$v)
        {
            ...
            $v['compare_time'] = compare_to_now($v['time_51']);
